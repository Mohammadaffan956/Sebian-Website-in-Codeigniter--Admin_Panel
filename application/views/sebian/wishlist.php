        ...
        <div class="shopping-cart text-left">
          <div class="cart-head">
            <ul class="row">
              ...
              <li class="col-sm-2">  <h6>Avaliblity</h6></li>
          ...
          <ul class="row cart-details">
            <li class="col-sm-5">
              <div class="media"> 
                <!-- Media Image -->
                <div class="media-left media-middle"> <a href="#." class="item-img"> <img class="media-object" src="images/week-img-2.jpg" alt=""> </a> </div>
