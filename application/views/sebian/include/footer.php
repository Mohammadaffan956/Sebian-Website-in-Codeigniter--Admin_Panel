 <!--======= Footer =========-->
  <footer>
    <div class="container">
      <div class="text-center"> <a href="#."><img src="assets/images/logo.png" alt=""></a><br>
        <img class="margin-t-40" src="assets/images/hammer.png" alt="">
        ...
        <div class="col-md-6">
          <ul>
            ...
            <li class="col-sm-6">
              <h5>INFOMATION</h5>
              <ul class="f-links">
                <?php foreach($contentinfo as $ct_data){ ?>
                <li><?= anchor("sebian_controller/content_page" , 'About') ?></li>
                <?php } ?>
              </ul>
            </li>
        ...
        <div class="col-md-6">
          <ul class="row">
            ...
            <li class="col-sm-6">
              <h5>FLICKR PHOTO</h5>
              <ul class="flicker">
                <li><a href="#."><img src="assets/images/flicker-1.jpg" alt=""></a></li>
                <li><a href="#."><img src="assets/images/flicker-2.jpg" alt=""></a></li>
                <li><a href="#."><img src="assets/images/flicker-3.jpg" alt=""></a></li>
                <li><a href="#."><img src="assets/images/flicker-4.jpg" alt=""></a></li>
                <li><a href="#."><img src="assets/images/flicker-5.jpg" alt=""></a></li>
                <li><a href="#."><img src="assets/images/flicker-6.jpg" alt=""></a></li>
              </ul>
            </li>
          </ul>
        </div>
