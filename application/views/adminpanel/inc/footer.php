	...
	<script src="<?= base_url() ?>adminpanel_assets/js/lib/tether/tether.min.js"></script>
	<script src="<?= base_url() ?>adminpanel_assets/js/lib/bootstrap/bootstrap.min.js"></script>
	<script src="<?= base_url() ?>adminpanel_assets/js/plugins.js"></script>

	<script type="text/javascript" src="<?= base_url() ?>adminpanel_assets/js/lib/jqueryui/jquery-ui.min.js"></script>
	<script type="text/javascript" src="<?= base_url() ?>adminpanel_assets/js/lib/lobipanel/lobipanel.min.js"></script>
	<script type="text/javascript" src="<?= base_url() ?>adminpanel_assets/js/lib/match-height/jquery.matchHeight.min.js"></script>
...
<script src="<?= base_url() ?>adminpanel_assets/js/app.js"></script>
</body>
</html>